...
// stage content:
(lib.appbuilder_336x280 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.s7.name = "s7";
	this.s7.setTransform(195.7,149.65,1.2991,1.2905,0,0,0,6.2,6.3);
	this.s7._off = true;
	...
	this.s6.name = "s6";
	this.s6.setTransform(306.35,127.05,1.0917,1.0903,0,0,0,0.2,0.4);
	this.s6._off = true;
	...
	this.s5.name = "s5";
	this.s5.setTransform(468.9,294.95,1.8174,1.8172,0,0,0,6,5.9);
	this.s5._off = true;
	...
	this.s4.name = "s4";
	this.s4.setTransform(463.3,317.05,1.5621,1.5568,0,0,0,0.5,0.4);
	this.s4._off = true;
	...
	this.s3.name = "s3";
	this.s3.setTransform(286.45,102.6,1.2585,1.2544,0,0,0,7.9,8);
	this.s3._off = true;
	...
	this.s2.name = "s2";
	this.s2.setTransform(288.55,90.5,1.129,1.1279,0,0,0,0.1,0.1);
	this.s2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.s2).wait(80).to({_off:false},0).wait(107).to({alpha:0},13).wait(8).to({regX:0.4,regY:0.5,scaleX:1.1892,scaleY:1.1843,x:208.55,y:118.25,alpha:1},0).wait(237));

	// s1
	this.s1 = new lib.Symbol36();
	this.s1.name = "s1";
	this.s1.setTransform(258.05,125.8,1.4136,1.4136,0,0,0,5.7,5.7);
	this.s1._off = true;
	...
	this.instance.setTransform(339.4,34.9,1.12,1.12,0,0,0,105.9,16.1);
	this.instance.alpha = 0;
	...
	this.instance_1.setTransform(308.85,37.75,0.4633,0.4613,0,0,0,213.2,33.6);
	...
	this.instance_2.setTransform(272.1,357.45,0.5622,0.5631,0,0,0,77.2,128.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90).to({_off:false},0).to({y:217.45},18,cjs.Ease.backOut).wait(337));

	// Layer_8
	this.instance_3 = new lib.Symbol21();
	this.instance_3.setTransform(-140.95,262.35,0.6877,0.6888,0,0,0,211.1,117.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(71).to({_off:false},0).to({regX:211.2,regY:117.6,scaleX:0.7734,scaleY:0.7746,x:162.25,y:260.75},19,cjs.Ease.backOut).wait(355));

	// logo
	this.instance_4 = new lib.Symbol19();
	this.instance_4.setTransform(90.8,28.75,0.2461,0.2433,0,0,0,303.6,53.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(445));

	// pc
	this.instance_5 = new lib.Symbol20();
	this.instance_5.setTransform(169.4,203,0.4434,0.4423,0,0,0,308.9,184.2);
	...
	this.instance_6.setTransform(254.7,33.9,1.0298,1.0269,0,0,0,110.4,28.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(300).to({scaleX:1.1877,scaleY:1.1843,x:254.65,y:34},10,cjs.Ease.quadOut).to({scaleX:1.0298,scaleY:1.0269,x:254.7,y:33.9},10,cjs.Ease.quadOut).wait(125));

	// Layer_14
	this.instance_7 = new lib.Symbol29();
	this.instance_7.setTransform(317.75,32.35,1.12,1.12,0,0,0,106,12.9);
	...
	this.instance_8.setTransform(320.8,58.65,1.12,1.12,0,0,0,114.3,30.4);
	...
	this.instance_9.setTransform(168,336,1.12,1.12,0,0,0,150,300);
...
p.nominalBounds = new cjs.Rectangle(-139.1,139,615.1,312);
// library properties:
lib.properties = {
