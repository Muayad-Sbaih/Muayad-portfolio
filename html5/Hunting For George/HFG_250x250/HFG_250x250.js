...
(lib.HFG_250x250 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(154).to({_off:false},0).to({y:177.1,alpha:1},7,cjs.Ease.get(1)).wait(85));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(147).to({_off:false},0).to({x:114.5,alpha:1},7,cjs.Ease.get(1)).wait(92));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(137).to({_off:false},0).wait(109));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(110).to({_off:false},0).wait(136));

	// Layer 1
	this.instance_4 = new lib.Symbol16();
	this.instance_4.parent = this;
	this.instance_4.setTransform(128.9,109.3,0.968,0.967,0,0,0,122.7,11.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(53).to({_off:false},0).to({y:122.3,alpha:1},6).wait(20).to({alpha:0},2,cjs.Ease.get(1)).wait(165));

	// Layer 2
	this.instance_5 = new lib.Symbol2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(124.4,106.2,1.019,1.017,0,0,0,104.5,13.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(26).to({_off:false},0).to({regY:13.2,y:118.9,alpha:1},7).wait(20).to({y:132.9,alpha:0},6).to({_off:true},1).wait(186));

	// logo
	this.instance_6 = new lib.Symbol1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(125.5,117.6,0.363,0.363,0,0,0,271.6,31.2);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({y:120.9,alpha:1},8,cjs.Ease.get(1)).wait(18).to({y:134.3,alpha:0},7).wait(47).to({y:111.7,alpha:1},0).to({regX:271.9,regY:31.5,scaleX:0.32,scaleY:0.31,x:125.6,y:19},9,cjs.Ease.get(1)).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(79).to({_off:false},0).to({regY:29.6,scaleY:0.66,y:19.5},9,cjs.Ease.get(1)).wait(158));

	// Layer 4
	this.instance_8 = new lib.Symbol4();
	this.instance_8.parent = this;
	this.instance_8.setTransform(125.6,125.2,4.287,4.273,0,0,0,29.3,29.3);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(101).to({_off:false},0).to({alpha:0.648},8).wait(137));

	// bg
	this.instance_9 = new lib.Symbol23();
	this.instance_9.parent = this;
	this.instance_9.setTransform(125,125,1,1,0,0,0,125,125);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(79).to({_off:false},0).wait(167));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1514509787202", id:"bg"}
	],
	preloads: []
};
