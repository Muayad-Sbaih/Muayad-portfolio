...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-239.6,1.8,1.371,1.372,0,0,0,121.5,9.9);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({y:-6.1,alpha:1},5,cjs.Ease.get(1)).wait(5));

	// Layer 7
	this.instance_1 = new lib.Symbol1_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-653.1,-2,0.426,0.423,0,0,0,171.1,65.2);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-554.2,-15.7,0.496,0.493,0,0,0,268.3,28.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).to({y:-7.8,alpha:1},5).wait(10));
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(25.9,13,1.011,1.01,0,0,0,44.4,12.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha:0},2,cjs.Ease.get(1)).to({_off:true},1).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(14).to({_off:false},0).to({y:-3.8,alpha:1},4).wait(1));

	// Layer 2
	this.instance_5 = new lib.Symbol14();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-625.7,-5.9,0.812,1.8,0,0,0,134.9,21.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:134.8,regY:21.8,scaleX:3.28,x:-292.9,y:-6.1,alpha:0.648},9,cjs.Ease.get(1)).wait(10));

	// Layer 6
	this.instance_6 = new lib.Symbol22();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-600.5,66.9,1,1,0,0,0,134.8,112.4);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({alpha:1},9,cjs.Ease.get(-0.8)).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-735.3,-45.5,872.2,80.9);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666666").s().p("EhK6ALeIAA27MCV1AAAIAAW7g");
	this.shape.setTransform(-345.9,-3.4);
...
// stage content:
(lib.HFG_970x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(891.6,72,1.144,1.143,0,0,0,0,0.2);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Symbol18(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(141).to({_off:false},0).to({y:46,alpha:1},7,cjs.Ease.get(1)).wait(96));

	// upto
	this.instance_1 = new lib.Symbol24();
	this.instance_1.parent = this;
	this.instance_1.setTransform(694.3,47.4,1.327,1.326,0,0,0,209.8,130.6);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(391.8,47.1,0.6,0.599,0,0,0,199.8,44.6);
	this.instance_2._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(483.4,32.6,1.752,1.747,0,0,0,104.5,12.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(485.2,37.2,0.545,0.543,0,0,0,271.8,30.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(77).to({_off:false},0).to({regY:29.6,scaleX:4.29,x:125.7,y:45.6},9,cjs.Ease.get(1)).wait(158));
...
p.nominalBounds = new cjs.Rectangle(822,65.4,296,33.3);
// library properties:
lib.properties = {
	width: 970,
	height: 90,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1514509615108", id:"bg"}
	],
	preloads: []
};
