...
(lib.HFG_200x200 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(154).to({_off:false},0).to({y:141.7,alpha:1},7,cjs.Ease.get(1)).wait(85));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(147).to({_off:false},0).to({x:91.7,alpha:1},7,cjs.Ease.get(1)).wait(92));
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(103.1,87.4,0.775,0.773,0,0,0,122.7,11.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(53).to({_off:false},0).to({y:97.8,alpha:1},6).wait(20).to({alpha:0},2,cjs.Ease.get(1)).wait(165));

	// Layer 2
	this.instance_5 = new lib.Symbol2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(99.5,85,0.815,0.814,0,0,0,104.5,13.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(26).to({_off:false},0).to({regY:13.2,y:95.1,alpha:1},7).wait(20).to({y:106.3,alpha:0},6).to({_off:true},1).wait(186));

	// logo
	this.instance_6 = new lib.Symbol1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(100.4,94.1,0.291,0.29,0,0,0,271.7,31.4);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regY:31.2,y:96.7,alpha:1},8,cjs.Ease.get(1)).wait(18).to({y:107.4,alpha:0},7).wait(47).to({y:89.4,alpha:1},0).to({regX:272.1,regY:31.7,scaleX:0.25,scaleY:0.25,x:100.5,y:15.2},9,cjs.Ease.get(1)).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(79).to({_off:false},0).to({regY:29.6,scaleY:0.53,y:15.6},9,cjs.Ease.get(1)).wait(158));

	// Layer 4
	this.instance_8 = new lib.Symbol4();
	this.instance_8.parent = this;
	this.instance_8.setTransform(100.5,100.2,3.43,3.419,0,0,0,29.3,29.3);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(100,100,0.8,0.8,0,0,0,125,125);
