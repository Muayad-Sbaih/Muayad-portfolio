...
// stage content:
(lib.HFG_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(228.1,237.4,1.112,1.112);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Symbol18(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(140).to({_off:false},0).to({y:218.4,alpha:1},7,cjs.Ease.get(1)).wait(86));

	// Layer 8
	this.instance_1 = new lib.Symbol9();
	this.instance_1.parent = this;
	this.instance_1.setTransform(199.4,147,0.7,0.698,0,0,0,92.5,51.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(130).to({_off:false},0).to({regX:92.4,scaleX:0.57,scaleY:0.57,x:199.3,y:146.9},6,cjs.Ease.get(1)).to({regX:92.3,regY:51.5,scaleX:0.59,scaleY:0.59},3).wait(94));

	// Layer 11
	this.instance_2 = new lib.Symbol21();
	this.instance_2.parent = this;
	this.instance_2.setTransform(171.2,109.6,0.971,0.969,0,0,0,199.3,137.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(107).to({_off:false},0).wait(126));

	// Layer 1
	this.instance_3 = new lib.Symbol16();
	this.instance_3.parent = this;
	this.instance_3.setTransform(154.8,110.9,1.09,1.09,0,0,0,123.1,11.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({_off:false},0).to({y:122.9,alpha:1},7).wait(18).to({alpha:0},2,cjs.Ease.get(1)).to({_off:true},1).wait(154));

	// Layer 2
	this.instance_4 = new lib.Symbol2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(148.8,98.6,1.219,1.217,0,0,0,104.5,13.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(25).to({_off:false},0).to({y:117.6,alpha:1},7).wait(19).to({y:133.6,alpha:0},7).to({_off:true},1).wait(174));

	// logo
	this.instance_5 = new lib.Symbol1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(150.1,116.1,0.435,0.434,0,0,0,271.6,31.1);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:120.1,alpha:1},8,cjs.Ease.get(1)).wait(17).to({y:134.1,alpha:0},7).wait(45).to({y:109.1,alpha:1},0).to({regX:271.8,regY:31.4,scaleX:0.38,scaleY:0.38,x:150.2,y:23.3},9,cjs.Ease.get(1)).wait(147));

	// Layer 5
	this.instance_6 = new lib.Symbol4();
	this.instance_6.parent = this;
	this.instance_6.setTransform(150.3,125.2,5.128,4.273,0,0,0,29.3,29.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(76).to({_off:false},0).to({regY:29.6,scaleY:0.79,y:23.3},9,cjs.Ease.get(1)).wait(148));

	// Layer 4
	this.instance_7 = new lib.Symbol4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(150.3,125.2,5.128,4.273,0,0,0,29.3,29.3);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(98).to({_off:false},0).to({alpha:0.648},8).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(76).to({_off:false},0).wait(157));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(182,227.6,236,26.6);
// library properties:
lib.properties = {
	width: 300,
	height: 250,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1514509460530", id:"bg"}
	],
	preloads: []
};
