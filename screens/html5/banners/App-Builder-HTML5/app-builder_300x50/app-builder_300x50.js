...
// stage content:
(lib.appbuilder_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_6.setTransform(-41,0,0.2892,0.2778);
...
p.nominalBounds = new cjs.Rectangle(109,25,271.1,25);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1713232361568", id:"bg"}
	],
	preloads: []
};
