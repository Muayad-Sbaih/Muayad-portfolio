...
// stage content:
(lib.HFG_250x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(190.6,185.1,0.93,0.93);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Symbol18(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(148).to({_off:false},0).to({y:177.1,alpha:1},7,cjs.Ease.get(1)).wait(89));

	// Layer 6
	this.instance_1 = new lib.Symbol25();
	this.instance_1.parent = this;
	this.instance_1.setTransform(94.5,224.3,1,1,0,0,0,118.5,27.6);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(141).to({_off:false},0).to({x:114.5,alpha:1},7,cjs.Ease.get(1)).wait(96));

	// upto
	this.instance_2 = new lib.Symbol24();
	this.instance_2.parent = this;
	this.instance_2.setTransform(190.7,120.1,1.016,1.016,0,0,0,166,142.5);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(142.1,88.2,0.811,0.81,0,0,0,199.2,137.8);
	this.instance_3._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(124.4,111.2,1.019,1.017,0,0,0,104.5,13.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(33).to({_off:false},0).to({regY:13.2,y:118.9,alpha:1},8,cjs.Ease.get(-1)).wait(36).to({alpha:0},2,cjs.Ease.get(1)).wait(165));

	// logo
	this.instance_5 = new lib.Symbol1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(125.5,117.6,0.363,0.363,0,0,0,271.6,31.2);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:120.9,alpha:1},8,cjs.Ease.get(1)).wait(25).to({y:129.3,alpha:0},8,cjs.Ease.get(1)).wait(37).to({y:111.7,alpha:1},0).to({regX:271.9,regY:31.5,scaleX:0.32,scaleY:0.31,x:125.6,y:19},9,cjs.Ease.get(1)).wait(157));

	// Layer 5
	this.instance_6 = new lib.Symbol4();
	this.instance_6.parent = this;
	this.instance_6.setTransform(125.6,125.2,4.287,4.273,0,0,0,29.3,29.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(77).to({_off:false},0).to({regY:29.6,scaleY:0.66,y:19.5},9,cjs.Ease.get(1)).wait(158));

	// Layer 4
	this.instance_7 = new lib.Symbol4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(125.6,125.2,4.287,4.273,0,0,0,29.3,29.3);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(125,125,1,1,0,0,0,125,125);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(77).to({_off:false},0).wait(167));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(151.8,231.3,197.3,22.2);
// library properties:
lib.properties = {
	width: 250,
	height: 250,
