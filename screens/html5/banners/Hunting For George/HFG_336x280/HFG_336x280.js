...
}).prototype = getMCSymbolPrototype(lib.Symbol22, new cjs.Rectangle(0,0,269.8,224.8), null);
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-23.5,-104.7,1,1,0,0,0,123,11);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({y:-98.2,alpha:1},5,cjs.Ease.get(1)).wait(5));

	// Layer 4
	this.instance_1 = new lib.Symbol1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-25.9,-182,0.341,0.339,0,0,0,271.3,31.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-24.3,y:-131.8},9).wait(10));
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(-24.4,-46,1.202,1.202,0,0,0,44.4,12.3);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(-25.5,-180.1,1,1,0,0,0,134.9,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:21.9,scaleY:5.19,y:-88.6,alpha:0.648},9,cjs.Ease.get(1)).wait(10));

	// Layer 6
	this.instance_5 = new lib.Symbol22();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-25.6,-89.7,1,1,0,0,0,134.8,112.4);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({alpha:1},9,cjs.Ease.get(-0.8)).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-160.4,-202.1,269.9,224.8);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(-66.8,-94);
...
// stage content:
(lib.HFG_336x280 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(255.4,267.6,1.246,1.246);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Symbol18(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(141).to({_off:false},0).to({y:244.6,alpha:1},7,cjs.Ease.get(1)).wait(96));

	// Layer 8
	this.instance_1 = new lib.Symbol9();
	this.instance_1.parent = this;
	this.instance_1.setTransform(223.3,164.6,0.784,0.782,0,0,0,92.5,51.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(131).to({_off:false},0).to({regY:51.8,scaleX:0.64,scaleY:0.64,x:223.2,y:164.7},6,cjs.Ease.get(1)).to({regX:92.3,regY:51.6,scaleX:0.66,scaleY:0.66,y:164.6},3).wait(104));

	// Layer 11
	this.instance_2 = new lib.Symbol21();
	this.instance_2.parent = this;
	this.instance_2.setTransform(191.7,122.8,1.087,1.085,0,0,0,199.3,137.8);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(166.7,121.6,1.365,1.363,0,0,0,104.5,13.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(33).to({_off:false},0).to({y:131.6,alpha:1},8,cjs.Ease.get(-1)).wait(36).to({alpha:0},2,cjs.Ease.get(1)).wait(165));

	// logo
	this.instance_4 = new lib.Symbol1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(168.1,130.1,0.487,0.486,0,0,0,271.6,31.2);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({y:134.5,alpha:1},8,cjs.Ease.get(1)).wait(25).to({y:145.7,alpha:0},8,cjs.Ease.get(1)).wait(37).to({y:122.2,alpha:1},0).to({regX:271.8,regY:31.5,scaleX:0.42,scaleY:0.42,x:168.2,y:26.1},9,cjs.Ease.get(1)).wait(157));

	// Layer 5
	this.instance_5 = new lib.Symbol4();
	this.instance_5.parent = this;
	this.instance_5.setTransform(168.3,140.3,5.744,4.786,0,0,0,29.3,29.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(77).to({_off:false},0).to({regY:29.6,scaleY:0.88,y:26.1},9,cjs.Ease.get(1)).wait(158));

	// Layer 4
	this.instance_6 = new lib.Symbol4();
	this.instance_6.parent = this;
	this.instance_6.setTransform(168.3,140.3,5.744,4.786,0,0,0,29.3,29.3);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(168,140,1.12,1.12,0,0,0,150,125);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(77).to({_off:false},0).wait(167));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(203.8,254.9,264.3,29.8);
// library properties:
lib.properties = {
	width: 336,
	height: 280,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1514507680616", id:"bg"}
	],
	preloads: []
};
