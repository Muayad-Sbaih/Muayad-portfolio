...
(lib.Symbol25 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(208.8,24.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiGCCQg2g0AAhOQAAhNA2g0QA2g0BQAAQBRAAA3A0QA2A0AABNQAABOg2A0Qg3A0hRAAQhQAAg2g0gAhEhDQgcAcAAAnQABAoAcAcQAcAcAnAAQAoAAAcgcQAdgcAAgoQAAgngdgcQgcgcgoAAQgnAAgdAcg");
	this.shape_1.setTransform(161.9,24.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("ABSCrIijjQIAADQIhYAAIAAlVIBYAAICjDQIAAjQIBYAAIAAFVg");
	this.shape_2.setTransform(120.2,24.4);
...
}).prototype = getMCSymbolPrototype(lib.Symbol25, new cjs.Rectangle(0,0,237,55.3), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol23, new cjs.Rectangle(0,0,250,250), null);
...
(lib.Symbol24 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:92.4,regY:51.8,scaleX:0.48,scaleY:0.48},6,cjs.Ease.get(1)).to({regX:92.3,regY:51.6,scaleX:0.5,scaleY:0.49,y:143.3},3).wait(1));
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-23.1,-73,1.077,1.077,0,0,0,123,11);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({y:-69.4,alpha:1},5,cjs.Ease.get(1)).wait(5));

	// Layer 4
	this.instance_1 = new lib.Symbol1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-25.9,-186,0.341,0.339,0,0,0,271.3,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:271.1,regY:31.4,scaleX:0.37,scaleY:0.37,x:-24.1,y:-105.6},9).wait(10));

	// Layer 1
	this.instance_2 = new lib.Symbol20();
	this.instance_2.parent = this;
	this.instance_2.setTransform(44.5,-5.3,1,1,0,0,0,44.5,12.3);

	this.instance_3 = new lib.Symbol20copy();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-24.1,-13.2,1.295,1.295,0,0,0,44.4,12.3);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:0},2,cjs.Ease.get(1)).to({_off:true},1).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(14).to({_off:false},0).to({alpha:1},3).wait(2));

	// Layer 2
	this.instance_4 = new lib.Symbol14();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-25.6,-177.7,1,0.999,0,0,0,134.9,21.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:134.8,regY:22,scaleY:6.29,x:-26.2,y:-58.6,alpha:0.648},9,cjs.Ease.get(1)).wait(10));

	// Layer 6
	this.instance_5 = new lib.Symbol23();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-26.5,-61.5,1.072,1.072,0,0,0,125,125);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({alpha:1},9,cjs.Ease.get(-0.8)).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-160.5,-199,269.9,271.5);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666666").s().p("A/Ua9MAAAg15MA+pAAAMAAAA15g");
	this.shape.setTransform(-66.8,-52.7);
...
// stage content:
(lib.HFG_200x200 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(152.5,148.1,0.744,0.744,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Symbol18(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(148).to({_off:false},0).to({y:141.7,alpha:1},7,cjs.Ease.get(1)).wait(89));

	// Layer 6
	this.instance_1 = new lib.Symbol25();
	this.instance_1.parent = this;
	this.instance_1.setTransform(75.7,179.5,0.8,0.8,0,0,0,118.5,27.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(141).to({_off:false},0).to({x:91.7,alpha:1},7,cjs.Ease.get(1)).wait(96));

	// upto
	this.instance_2 = new lib.Symbol24();
	this.instance_2.parent = this;
	this.instance_2.setTransform(152.6,96,0.813,0.812,0,0,0,166.1,142.4);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(113.7,70.5,0.649,0.648,0,0,0,199.2,137.7);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(108).to({_off:false},0).wait(136));

	// Layer 2
	this.instance_4 = new lib.Symbol2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(99.5,89,0.815,0.814,0,0,0,104.5,13.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(33).to({_off:false},0).to({regY:13.2,y:95.1,alpha:1},8,cjs.Ease.get(-1)).wait(36).to({alpha:0},2,cjs.Ease.get(1)).wait(165));

	// logo
	this.instance_5 = new lib.Symbol1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(100.4,94.1,0.291,0.29,0,0,0,271.7,31.4);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:31.2,y:96.7,alpha:1},8,cjs.Ease.get(1)).wait(25).to({y:103.4,alpha:0},8,cjs.Ease.get(1)).wait(37).to({y:89.4,alpha:1},0).to({regX:272.1,regY:31.7,scaleX:0.25,scaleY:0.25,x:100.5,y:15.2},9,cjs.Ease.get(1)).wait(157));

	// Layer 5
	this.instance_6 = new lib.Symbol4();
	this.instance_6.parent = this;
	this.instance_6.setTransform(100.5,100.2,3.43,3.419,0,0,0,29.3,29.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(77).to({_off:false},0).to({regY:29.6,scaleY:0.53,y:15.6},9,cjs.Ease.get(1)).wait(158));

	// Layer 4
	this.instance_7 = new lib.Symbol4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(100.5,100.2,3.43,3.419,0,0,0,29.3,29.3);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(100,100,0.8,0.8,0,0,0,125,125);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(77).to({_off:false},0).wait(167));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(121.4,185,157.9,17.8);
// library properties:
lib.properties = {
	width: 200,
	height: 200,
