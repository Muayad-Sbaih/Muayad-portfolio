...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(-419.4,-17.1,0.692,1.982,0,0,0,134.9,21.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:134.8,scaleX:3.28,x:-71,y:-17.5,alpha:0.648},9,cjs.Ease.get(1)).wait(10));

	// Layer 6
	this.instance_6 = new lib.Symbol22();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-378.6,54,1,1,0,0,0,134.8,112.4);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({alpha:1},9,cjs.Ease.get(-0.8)).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-513.4,-60.3,872.2,87.3);
...
// stage content:
(lib.HFG_468x60 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(419.6,48.2,0.753,0.752,0,0,0,0,0.3);
	this.instance.alpha = 0;
	this.instance._off = true;
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Symbol18(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(141).to({_off:false},0).to({y:39.9,alpha:1},7,cjs.Ease.get(1)).wait(96));

	// upto
	this.instance_1 = new lib.Symbol24();
	this.instance_1.parent = this;
	this.instance_1.setTransform(41.7,-81.4,0.944,0.943);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(242,18.2,0.432,0.431,0,0,0,201.1,43.3);
	this.instance_2._off = true;
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(60.7,36.1,0.314,0.312,0,0,0,171.3,65.2);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(85).to({_off:false},0).to({regY:65.3,y:32.9,alpha:1},7,cjs.Ease.get(1)).wait(152));

	// url
	this.instance_4 = new lib.Symbol2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(233.5,22,1.129,1.126,0,0,0,104.5,12.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(33).to({_off:false},0).to({y:27.1,alpha:1},8,cjs.Ease.get(-1)).wait(36).to({x:118.2,alpha:0},8,cjs.Ease.get(1)).wait(159));

	// logo
	this.instance_5 = new lib.Symbol1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(234.7,25,0.351,0.35,0,0,0,271.9,31);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:30.9,y:30.1,alpha:1},8,cjs.Ease.get(1)).wait(25).to({y:38.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(202));

	// logo bg
	this.instance_6 = new lib.Symbol4();
	this.instance_6.parent = this;
	this.instance_6.setTransform(313.1,30.1,10.686,0.991,0,0,0,29.3,29.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(77).to({_off:false},0).to({regY:29.6,scaleX:2.4,x:70.4,y:30.4},9,cjs.Ease.get(1)).wait(158));

	// black bg
	this.instance_7 = new lib.Symbol4copy();
	this.instance_7.parent = this;
	this.instance_7.setTransform(313.1,30.1,10.686,0.991,0,0,0,29.3,29.3);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(100,83.4,0.667,0.667,0,0,0,150,125.1);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(77).to({_off:false},0).wait(167));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(373.2,44.1,190.7,21.4);
// library properties:
lib.properties = {
	width: 468,
	height: 60,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1514509600114", id:"bg"}
	],
	preloads: []
};
